...
.field b:Landroidx/appcompat/view/menu/n;
...
.method public a(Landroid/content/Context;Landroidx/appcompat/view/menu/k;)V
    ...
    .line 1
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$a;->a:Landroidx/appcompat/view/menu/k;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar$a;->b:Landroidx/appcompat/view/menu/n;

    if-eqz v0, :cond_0

    .line 2
    invoke-virtual {p1, v0}, Landroidx/appcompat/view/menu/k;->a(Landroidx/appcompat/view/menu/n;)Z

    .line 3
    :cond_0
    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$a;->a:Landroidx/appcompat/view/menu/k;
...
.method public a(Z)V
    ...
    .line 4
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$a;->b:Landroidx/appcompat/view/menu/n;
    ...
    .line 7
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar$a;->a:Landroidx/appcompat/view/menu/k;

    invoke-virtual {v2, v1}, Landroidx/appcompat/view/menu/k;->getItem(I)Landroid/view/MenuItem;

    move-result-object v2

    .line 8
    iget-object v3, p0, Landroidx/appcompat/widget/Toolbar$a;->b:Landroidx/appcompat/view/menu/n;
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/widget/Toolbar$a;->a(Landroidx/appcompat/view/menu/k;Landroidx/appcompat/view/menu/n;)Z
...
.method public a(Landroidx/appcompat/view/menu/k;Landroidx/appcompat/view/menu/n;)Z
    ...
    instance-of v0, p1, La/a/c/b;

    if-eqz v0, :cond_0

    .line 11
    check-cast p1, La/a/c/b;

    invoke-interface {p1}, La/a/c/b;->onActionViewCollapsed()V
    ...
    .line 16
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar$a;->b:Landroidx/appcompat/view/menu/n;
    ...
    .line 18
    invoke-virtual {p2, p1}, Landroidx/appcompat/view/menu/n;->a(Z)V
...
.method public b(Landroidx/appcompat/view/menu/k;Landroidx/appcompat/view/menu/n;)Z
    ...
    invoke-virtual {p2}, Landroidx/appcompat/view/menu/n;->getActionView()Landroid/view/View;
    ...
    .line 8
    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$a;->b:Landroidx/appcompat/view/menu/n;
    ...
    instance-of v0, p2, La/a/c/b;

    if-eqz v0, :cond_4

    .line 22
    check-cast p2, La/a/c/b;

    invoke-interface {p2}, La/a/c/b;->onActionViewExpanded()V

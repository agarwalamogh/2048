...
.field g:Landroidx/appcompat/view/menu/k$b;

.field private h:Landroidx/appcompat/widget/E;
...
.method private n()V
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->d:Landroidx/appcompat/view/menu/n;

    .line 3
    invoke-virtual {v2}, Landroidx/appcompat/view/menu/n;->n()Z
    ...
    invoke-virtual {v2}, Landroidx/appcompat/view/menu/n;->getContentDescription()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Landroidx/appcompat/view/menu/n;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Landroidx/appcompat/view/menu/n;->getTooltipText()Ljava/lang/CharSequence;
    ...
    .line 11
    :cond_5
    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->d:Landroidx/appcompat/view/menu/n;

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/n;->getTitle()Ljava/lang/CharSequence;

    move-result-object v1

    :goto_4
    invoke-static {p0, v1}, Landroidx/appcompat/widget/pa;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    goto :goto_5

    .line 12
    :cond_6
    invoke-static {p0, v2}, Landroidx/appcompat/widget/pa;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
# virtual methods
.method public a(Landroidx/appcompat/view/menu/n;I)V
    .locals 0

    .line 1
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->d:Landroidx/appcompat/view/menu/n;

    .line 2
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/n;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    .line 3
    invoke-virtual {p1, p0}, Landroidx/appcompat/view/menu/n;->a(Landroidx/appcompat/view/menu/u$a;)Ljava/lang/CharSequence;
    ...
    .line 4
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/n;->getItemId()I
    ...
    .line 5
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/n;->isVisible()Z
    ...
    .line 8
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Landroidx/appcompat/widget/E;
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Landroidx/appcompat/widget/E;
...
.method public c()Z
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/n;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public getItemData()Landroidx/appcompat/view/menu/n;
    .locals 1
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 1
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->g:Landroidx/appcompat/view/menu/k$b;
    ...
    invoke-interface {p1, v0}, Landroidx/appcompat/view/menu/k$b;->a(Landroidx/appcompat/view/menu/n;)Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 3
    invoke-direct {p0}, Landroidx/appcompat/view/menu/ActionMenuItemView;->n()V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Landroidx/appcompat/view/menu/n;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->h:Landroidx/appcompat/widget/E;
...
.method public setExpandedFormat(Z)V
    ...
    .line 3
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->d:Landroidx/appcompat/view/menu/n;

    if-eqz p1, :cond_0

    .line 4
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/n;->b()V
...
.method public setItemInvoker(Landroidx/appcompat/view/menu/k$b;)V
    .locals 0

    .line 1
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->g:Landroidx/appcompat/view/menu/k$b;
